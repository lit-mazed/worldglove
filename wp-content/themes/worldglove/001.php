...
<head>
<title>001 Standard</title>
<meta charset="UTF-8">
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/001.css" type="text/css">
    ...
    <span>||　Glove & Socks　画期的な技術で生まれたグローブやソックスのラインナップ。</span><br><br>
     <table class="table">
        <tbody>
            <tr>
                <td class="cmc set-1">            
                <p><span class="img  noborder "><a href="../products/001.html" data-pid="136518"><img src="<?php echo get_template_directory_uri(); ?>/images/000_4.jpg" width="150" height="150" alt="" style="display: inline;"></a></span></p> 
                </td>
                <td class="cmc set-1">            
                <p><span class="img  noborder "><a href="../products/001.html" data-pid="136518"><img src="<?php echo get_template_directory_uri(); ?>/images/000_5.jpg" width="150" height="150" alt="" style="display: inline;"></a></span></p> 
                </td>
                 <td class="cmc set-1">            
                <p><span class="img  noborder "><a href="../products/001.html" data-pid="136518"><img src="<?php echo get_template_directory_uri(); ?>/images/000_6.jpg" width="150" height="150" alt="" style="display: inline;"></a></span></p> 
                </td>
                <td class="cmc set-1">            
                <p><span class="img  noborder "><a href="../products/001.html" data-pid="136518"><img src="<?php echo get_template_directory_uri(); ?>/images/000_7.jpg" width="150" height="150" alt="" style="display: inline;"></a></span></p> 
                </td>
            </tr> 
            <tr>
                <td class="cmc set-1">            
                <p><span class="img  noborder "><a href="../products/001.html" data-pid="136518"><img src="<?php echo get_template_directory_uri(); ?>/images/000_8.jpg" width="150" height="150" alt="" style="display: inline;"></a></span></p> 
                </td>
                <td class="cmc set-1">            
                <p><span class="img  noborder "><a href="../products/001.html" data-pid="136518"><img src="<?php echo get_template_directory_uri(); ?>/images/000_9.jpg" width="150" height="150" alt="" style="display: inline;"></a></span></p> 
                </td>
                 <td class="cmc set-1">            
                <p><span class="img  noborder "><a href="../products/001.html" data-pid="136518"><img src="<?php echo get_template_directory_uri(); ?>/images/000_10.jpg" width="150" height="150" alt="" style="display: inline;"></a></span></p> 
                </td>
                <td class="cmc set-1">            
                <p><span class="img  noborder "><a href="../products/001.html" data-pid="136518"><img src="<?php echo get_template_directory_uri(); ?>/images/000_11.jpg" width="150" height="150" alt="" style="display: inline;"></a></span></p> 
                </td>
            </tr>             
        </tbody>
    </table><br>
