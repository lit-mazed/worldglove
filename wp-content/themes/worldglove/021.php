...
<head>
<title>ARUQUITECT COOL 021</title>
<meta charset="UTF-8">
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/021.css" type="text/css">
...
<div class="wrapper row2">        
  ...
  <div class="bmc"> 
    ...
    <table class="table">
        <tbody>
            <tr>
                 <p><span class="img  noborder "><img src="<?php echo get_template_directory_uri(); ?>/images/cool_1.png" width="670" height="410" alt="" style="display: inline;" kasperskylab_antibanner="on">
                ...
                冷房の効いたオフィスや冬のキーボード操作に薄くて手にフィットするからスタイリッシュなあなたにぴったりの「潤いアイテム」です。</span>
                 ...
                 <span>||　Arquitect Cool 021</span><span ><a href=""></a><span><a href="" class="bmc-r">この商品を購入する<img src="<?php echo get_template_directory_uri(); ?>/images/square_wht_right.png" alt="" align="right"></a><br>   
                <br>
