...
<head>
<title>002 Light/W</title>
<meta charset="UTF-8">
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/003.css" type="text/css">
...
<div class="wrapper row2">        
  ...
  <div id="content">
  <div class="bmc"> 
    <span>||　002 Light/W</span><span ><a href=""></a><span><a href="" class="bmc-r">この商品を購入する<img src="<?php echo get_template_directory_uri(); ?>/images/square_wht_right.png" alt="" align="right"></a>   
    <table class="table">
        <tbody>
            <tr>
                 <p><span class="img  noborder "><img src="<?php echo get_template_directory_uri(); ?>/images/003_1.png" width="670px" alt="" style="display: inline;" kasperskylab_antibanner="on">
                 </span><span>ホワイトベースの、モイスト・コート® ライト 003。春を思わせる、やさしい色の薄手タイプ。<br>
                乾燥から手を守りながら薄くてフィットするから、いつでも、どこでも、フェミニンなあなたにぴったりの「潤いアイテム」。</span>
                 </p>
            </tr>
                <td class="cmc set-1">
                    <p><span class="img  noborder "><a href="../products/001.html" data-pid="136518"><img src="<?php echo get_template_directory_uri(); ?>/images/003_2.png" width="210" height="165" alt="" style="display: inline;" kasperskylab_antibanner="on"><img src="../_src/1969664/0002.jpg" width="210" height="210" alt="" class="over-img" style="display: none;" kasperskylab_antibanner="on"></a></span></p>
                   パステルの軽さ、フィット感、そして潤い。。
                </td>
                <td class="cmc set-1">
                    <p><span class="img  noborder "><a href="../products/002.html" data-pid="136520"><img src="<?php echo get_template_directory_uri(); ?>/images/003_3.jpg" width="210" height="165" alt="" kasperskylab_antibanner="on" style="display: inline;"><img src="../_src/1969668/img_0052.jpg" width="210" height="210" alt="" class="over-img" kasperskylab_antibanner="on" style="display: none;"></a></span></p>
                    切り傷が怖い事務作業もこれなら安心。                    
                </td>
                <td class="cmc set-1">
                    <p><span class="img  noborder "><a href="../products/002.html" data-pid="136520"><img src="<?php echo get_template_directory_uri(); ?>/images/003_4.png" width="210" height="165" alt="" kasperskylab_antibanner="on" style="display: inline;"><img src="../_src/1969668/img_0052.jpg" width="210" height="210" alt="" class="over-img" kasperskylab_antibanner="on" style="display: none;"></a></span></p>
    ...
    <div class="column set-1">
        <strong>&nbsp;商品詳細</strong><br><hr>
        <p><strong>■素材：</strong>ナイロン（コラーゲン加工）・ナイロン
        <br><strong>■サイズ：</strong>フリーサイズ
        <br>■<strong>カラーバリエーション：</strong>3色（ピーチ・ソーダ・レモン）
        <br>
     ...
     <table class="table">
        <tbody>
            <tr>             
                <td class="cmc set-1">            
                <p><span class="img  noborder "><a href="../products/001.html" data-pid="136518"><img src="<?php echo get_template_directory_uri(); ?>/images/003_5.jpg" width="150" height="150" alt="" style="display: inline;"></a>レモン</span></p> 
                </td>
                 <td class="cmc set-1">            
                <p><span class="img  noborder "><a href="../products/001.html" data-pid="136518"><img src="<?php echo get_template_directory_uri(); ?>/images/003_6.jpg" width="150" height="150" alt="" style="display: inline;"></a>ピーチ</span></p> 
                </td>
                <td class="cmc set-1">            
                <p><span class="img  noborder "><a href="../products/001.html" data-pid="136518"><img src="<?php echo get_template_directory_uri(); ?>/images/003_7.jpg" width="150" height="150" alt="" style="display: inline;"></a>ソーダ</span></p> 
                </td>
