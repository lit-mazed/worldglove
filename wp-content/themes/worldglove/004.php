...
<head>
<title>004 Touch</title>
<meta charset="UTF-8">
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/004.css" type="text/css">
...
<div class="wrapper row2">        
  ...
  <div id="content">
  <div class="bmc"> 
    <span>||　004 Touch</span><span ><a href=""></a><span><a href="" class="bmc-r">この商品を購入する<img src="<?php echo get_template_directory_uri(); ?>/images/square_wht_right.png" alt="" align="right"></a>   
    <table class="table">
        <tbody>
            <tr>
                 <p><span class="img  noborder "><img src="<?php echo get_template_directory_uri(); ?>/images/004_1.png" width="670px" alt="" style="display: inline;" kasperskylab_antibanner="on">
                ...
                <td class="cmc set-1">
                    <p><span class="img  noborder "><a href="../products/001.html" data-pid="136518"><img src="<?php echo get_template_directory_uri(); ?>/images/004_2.png" width="210" height="165" alt="" style="display: inline;" kasperskylab_antibanner="on"><img src="../_src/1969664/0002.jpg" width="210" height="210" alt="" class="over-img" style="display: none;" kasperskylab_antibanner="on"></a></span></p>
                    繊維に特殊加工されたコラーゲン・アミノ酸<br>によりお肌のうるおいを保ち続けます。
                </td>
                <td class="cmc set-1">
                    <p><span class="img  noborder "><a href="../products/002.html" data-pid="136520"><img src="<?php echo get_template_directory_uri(); ?>/images/004_3.png" width="210" height="165" alt="" kasperskylab_antibanner="on" style="display: inline;"><img src="../_src/1969668/img_0052.jpg" width="210" height="210" alt="" class="over-img" kasperskylab_antibanner="on" style="display: none;"></a></span></p>
                    優しいフィット感が特長。手首は締めつけない編み方で、袖はルーズなデザインです。                    
                </td>
                <td class="cmc set-1">
                    <p><span class="img  noborder "><a href="../products/002.html" data-pid="136520"><img src="<?php echo get_template_directory_uri(); ?>/images/004_4.png" width="210" height="165" alt="" kasperskylab_antibanner="on" style="display: inline;"><img src="../_src/1969668/img_0052.jpg" width="210" height="210" alt="" class="over-img" kasperskylab_antibanner="on" style="display: none;"></a></span></p>
    ...
    <strong><img src="<?php echo get_template_directory_uri(); ?>/images/h4.gif" alt="">&nbsp;商品詳細</strong>
     ...
     <table class="table">
        <tbody>
            <tr>
                <td class="cmc set-1">            
                <p><span class="img  noborder "><a href="../products/001.html" data-pid="136518"><img src="<?php echo get_template_directory_uri(); ?>/images/004_5.jpg" width="235" height="176" alt="" style="display: inline;"></a></span></p> 
                </td>                
                <td class="cmc set-1" style="width:100%;">            
                <p>■素材：ナイロン、導電糸
				<br>■サイズ：フリーサイズ
				<br>■カラー：ブラック＆シルバー／ブラック（袖）
				<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ブラック&ブラック（新色!!）<br>	
				<br>■ 原産地：日本
				<br>■ 受賞：2012年 福岡産業デザイン賞受賞
				<br>■ 知的財産：実用新案取得済・商標登録</span></p> 
                </td>
                <td class="cmc set-1">            
